...
map <- leaflet(options = leafletOptions(minZoom = 0.5)) %>%
  ...
  addLayersControl(
    baseGroups = c("Carto Voyager", "Esri World Imagery"),
    overlayGroups = labs,
  ...
  addLegend(
    ...
    position = "bottomright"
      ...
      htmlwidgets::onRender("
        function() {
            $('.leaflet-control-layers-list').prepend('<strong>Base mappend</strong>');
        }
    ") %>%  #RHH
      htmlwidgets::onRender("
        function() {
            $('.leaflet-control-layers-overlays').prepend('<strong style=\"text-align:right\">Risk level in Deutsch</strong>');
        }
    ")
map
```
