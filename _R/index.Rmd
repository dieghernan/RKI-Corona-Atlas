...
data_cntries$html_labels <- ifelse(data_cntries$ISO3_CODE != "DEU",
                                   paste0(data_cntries$html_labels,"<br />",data_cntries$risk_level_de),
...
date <- readr::read_csv("../assets/data/report_date.csv") %>%
...
und der geltenden Reisebeschränkungen jeder Risikostufe
empfiehlt sich
...
readr::write_delim(df, "../assets/dist/db_countries_risk_de.csv",
                  delim = ";",
                  na = "")
